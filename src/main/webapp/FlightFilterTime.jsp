...
<body style="background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
	...
	<div class="row"  style="font-size:120%; padding-top:2em;">
		...
		<div class="container" style="color:black; font-family:'Courier New', Courier, monospace; font-weight:bold; font-size:120%;">
			...
			<table class="table table-bordered" style=" font-weight:bold;">
				...
				<tbody>
					...
					<c:forEach var="filterFlight" items="${filterFlight}">
						...
						<tr>
							<td><c:out value="${filterFlight.id}" /></td>
							<td><c:out value="${filterFlight.departure_city}" /></td>
							<td><c:out value="${filterFlight.arrival_city}" /></td>
							...
							<td><c:out value="${filterFlight.legs}" /></td>
							<td><c:out value="${filterFlight.path}" /></td>
						</tr>
					</c:forEach>
