...
<body style="background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
	...
	<div class="row"  style="font-size:120%; padding-top:2em; background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
		...
		<div class="container" style="color:black; font-family:'Courier New', Courier, monospace; font-weight:bold">
			...
			<div class="container text-left" style="font-weight:bold; padding-left:80%;">
				...
				<a href="<%=request.getContextPath()%>/new" class="btn btn-success" style="background-color: #785649">Add
					New Flight</a>
			</div>
			<br>
				...
				<tbody>
					...
					<c:forEach var="listFlight" items="${listFlight}">
						...
						<tr>
							...
							<td><c:out value="${listFlight.path}" /></td>
