...
<body style="background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
	...
	<div class="row"  style="font-size:120%; background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
		<!-- <div class="alert alert-success" *ngIf='message'>{{message}}</div> -->

		<div class="container" style="color:black; font-family:'Courier New', Courier, monospace; font-weight:bold">
			<h3 class="text-center" style=" font-weight:bold">All Flights</h3>
			
			<div class="container text-right" style="padding-top:2em">
				<a href="<%=request.getContextPath()%>/filtertime" class="btn btn-success" style="background-color:#785649">Special Deals</a>
				...
				<tbody>
					...
					<c:forEach var="listFlight" items="${listFlight}">
						...
						<tr>
							...
							<td><c:out value="${listFlight.legs}" /></td>
							<td style="text-align:center;"><c:out value="${listFlight.path}" /></td>
						</tr>
					</c:forEach>
