...
<body style="background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
	...
	<div class="container col-md-5"  style="font-size:120%; background: black url('https://jooinn.com/images/brown-background-pattern-1.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940') no-repeat scroll center; background-size: cover; height: 100vh; color: #c8cfcf;">
		<div class="card" style="color:black; font-family:'Courier New', Courier, monospace; font-weight:bold; font-size:120%;">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Legs</label> <input type="text"
						value="<c:out value='${flight.legs}' />" class="form-control"
						name="legs">
				</fieldset>
				...
				<fieldset class="form-group">
					<label>Intermediate Haults</label> <input type="text"
						value="<c:out value='${flight.path}' />" class="form-control"
						name="path">
				</fieldset>
